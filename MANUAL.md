# Manual Setup Steps for Minions Agent-tasks
...
Go to **GitHub → mxn2020/minions-agent-tasks → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-agent-tasks` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-agent-tasks-web`
- **GitHub repo**: `mxn2020/minions-agent-tasks`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `agent-tasks.minions.wtf`

### Documentation
- **Netlify site name**: `minions-agent-tasks-docs`
- **GitHub repo**: `mxn2020/minions-agent-tasks`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `agent-tasks.minions.help`

### Blog
- **Netlify site name**: `minions-agent-tasks-blog`
- **GitHub repo**: `mxn2020/minions-agent-tasks`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `agent-tasks.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `agent-tasks.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `agent-tasks.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `agent-tasks.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-agent-tasks/sdk`](https://www.npmjs.com/package/@minions-agent-tasks/sdk)
- CLI: [`@minions-agent-tasks/cli`](https://www.npmjs.com/package/@minions-agent-tasks/cli)
...
Your package: [`minions-agent-tasks`](https://pypi.org/project/minions-agent-tasks/)
...
| Item | Value |
|------|-------|
| Project | `minions-agent-tasks` |
| SDK (npm) | `@minions-agent-tasks/sdk` |
| CLI (npm) | `@minions-agent-tasks/cli` |
| Python (PyPI) | `minions-agent-tasks` |
| GitHub | `github.com/mxn2020/minions-agent-tasks` |
| Docs domain | `agent-tasks.minions.help` |
| Blog domain | `agent-tasks.minions.blog` |
| App domain | `agent-tasks.minions.wtf` |
