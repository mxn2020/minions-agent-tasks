...
/**
 * @minions-agent-tasks/cli — CLI for Minions Agent-tasks
 *
...
import { customTypes } from '@minions-agent-tasks/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Agent-tasks'));
        console.log(chalk.dim('gh agent-task prompts, execution tracking, PR references, and review status'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-agent-tasks/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-agent-tasks/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-agent-tasks')}`);
